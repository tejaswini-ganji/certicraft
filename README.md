...
2.	Make sure all the related files such as sample template certificate_template.png and true type font file lora-bold.ttf are in the same folder.
...
7.	Finally, a certificate generated and successfully sent to email messages will be displayed in the terminal
